...
<head>
    ...
    <link rel="stylesheet" href="/src/assets/pages/Pagamento/style.css">
</head>
<body>
    <header>
      <div class="container">
  ...
  <div class="pagamento-info">
    <h1>PAGAMENTO</h1>
    <p>CARRINHO > ENTREGA > CONFIRMAÇÃO > PAGAMENTO </p>

    <form action="#" method="post" class="form-pagamento">
      <button type="submit" class="form-pag">SELECIONAR FORMA DE PAGAMENTO</button>
  ...
  <aside class="resumo">
    ...
    <div class="produto">
      <img src="/src/assets/image/conjunto.svg" alt="Imagem Produto">
      <p><strong>CONJUNTO EMPORIO ARMANI</strong></p>
      <p>Tamanho: GG • Masculino</p>
      <p>Preço: R$130,00</p>
    </div>
    ...
    <div class="pedido">
      ...
      <p>Taxas: R$ 0,00</p>
      <p>Desconto: R$ 0,00</p>
      <p><strong>Total: R$136,99</strong></p>
    </div>
  </aside>
</section>
